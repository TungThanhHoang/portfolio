...
function Poster() {
  return (
    <>
      <section className="h-screen md:pt-26 pt-10 background-container relative ">
        ...
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="flex flex-col md:flex-row  justify-between  relative ">
            <div  className=" mt-2 mb-12 md:mb-16 md:mt-10">
              ...
              <button data-aos="fade-right" data-aos-duration="2000" className="mt-5  bg-green-900 text-whitecustom px-6 py-3 rounded-xl font-medium text-sm md:text-md hover:bg-green-700 transition duration-200">
                Contact Me !
              </button>
            </div>
